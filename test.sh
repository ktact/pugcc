...
assert  4 "main() { foo=3; bar=5; return (foo+bar)/2; }"
assert  5 "main() { return 5; return 8; }"

assert  3 "main() { if (0) return 2; else return 3; }"
assert  3 "main() { if (1-1) return 2; else return 3; }"
assert  2 "main() { if (1) return 2; return 3; }"
assert  2 "main() { if (2-1) return 2; return 3; }"

assert 10 "main() { i = 0; while (i < 10) i = i + 1; return i; }"
assert  0 "main() { i = 0; while (0) i = 1; return i; }"

assert  9 "main() { ret = 0; for (i = 0; i < 10; i = i + 1) ret = i; return ret; }"
assert  0 "main() { ret = 0; for (i = 0; i > 1;  i = i + 1) ret = i; return ret; }"
assert 10 "main() { ret = 0; for (;ret < 10;) ret = ret + 1; return ret; }"
...
assert  3 "main() { x=1;y=2;return add(x,y);}"
assert  1 "main() { x=2;y=1;return sub(x,y);}"
